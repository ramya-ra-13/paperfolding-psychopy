...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/ramyaramakrishnan/Documents/gan-college/RA/Paper Folding Folder/Paper Folding PsychoPy.py',
...
response3 = visual.TextStim(win=win, name='response3',
    text='Press any key to continue.',
    font='Times New Roman',
    pos=(0, -0.4), height=0.040, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
...
ExProblem = visual.TextStim(win=win, name='ExProblem',
    text='Now try the sample problem on the next slide. (In this problem only one hole was punched in the folded paper.)\n\nRemember that each hole is punched through all the thicknesses of paper at that point. One of the five figures at the right will show where the holes will be when the paper is completely unfolded. You are to decide which one of these figures is correct and click the correct number (1, 2, 3, 4, or, 5) on your keyboard that you feel corresponds with this correct answer.',
    font='Times New Roman',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
_key_resp_5_allKeys = []
# keep track of which components have finished
instr_pt2Components = [Instr_part2, key_resp_5, response3]
...
thisExp.addData('response3.started', response3.tStartRefresh)
thisExp.addData('response3.stopped', response3.tStopRefresh)
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trial_1Components = [Questions_1, participant_response_1, resptrial1]
...
for thisTrial_2 in trials_2:
    ...
    # keep track of which components have finished
    trial_2Components = [Questions_2, participant_response_2, number]
